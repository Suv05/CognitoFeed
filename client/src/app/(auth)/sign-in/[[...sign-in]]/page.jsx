              ...
              >
                ...
                <div className="relative bg-gradient-to-br from-black/60 to-purple-950/40 backdrop-blur-xl border border-purple-500/30 rounded-2xl p-6 overflow-hidden">
                  ...
                  <div className="text-center mb-6">
                    ...
                    <p className="text-purple-200 text-sm">Continue to your dashboard</p>
                  </div>

                  {/* Clerk Sign In Component */}
                  <div className="clerk-signin-wrapper w-full overflow-hidden">
                    <SignIn
                      appearance={{
                        elements: {
          ...
          <div className="lg:w-1/2 flex flex-col justify-center px-12 xl:px-16">
            ...
            >
              ...
              <p className="text-xl text-purple-200 mb-8 max-w-md leading-relaxed">
                Access your personalized news sentiment dashboard
              </p>
                    ...
                    <SignIn
                      appearance={{
                        elements: {
                          ...
                          dividerText: "text-purple-200 text-sm",
                          formFieldInput:
                            "bg-black/40 border-purple-500/30 text-white placeholder:text-gray-400 focus:border-purple-400 focus:ring-purple-400/20 rounded-lg",
                          formFieldLabel: "text-purple-200 text-sm font-medium",
                          formButtonPrimary:
                            "bg-gradient-to-r from-purple-600 to-purple-500 hover:from-purple-700 hover:to-purple-600 text-white border-0 shadow-lg shadow-purple-500/25 rounded-lg font-medium transition-all duration-300",
